...
namespace BunnyHops
{
    class Program
    {
        ...
        {
            Console.WriteLine("Press down middle mouse button for some sweet bunnyhops.\n"
        ...
        private const UInt16 VK_MIDDLEBUTTON = 0x04;    // middle mouse button
        private const UInt16 VK_LBUTTON = 0x01;         // left mouse button
        private const UInt16 VK_RBUTTON = 0x02;         // right mouse button
        private const UInt16 VK_F5 = 0x74;              // F5 button
        private const int KEY_PRESSED = 0x8000;         // key pressed
